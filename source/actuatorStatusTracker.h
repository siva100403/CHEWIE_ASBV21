...
typedef union actuatorStatus {
    struct {
    	...
    	uint32_t lidStatus			: 3; //OPEN, OPENING, CLOSE, CLOSING, ERROR
    	uint32_t flapStatus			: 3; //OPEN, OPENING, CLOSE, CLOSING, ERROR
    	uint32_t stValveStatus		: 3; //OPEN, OPENING, CLOSE, CLOSING, ERROR
