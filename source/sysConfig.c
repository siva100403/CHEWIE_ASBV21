...
const dgShredderCtrlSeq_t shdCtrlSeqDefault[] = {
		{ 1000,  SEQ_CTRL_SHD_MOTOR_CCWR,  SEQ_CTRL_SHD_FLAP_OFF, SEQ_CTRL_FLUSH_OFF, SEQ_CTRL_SHDAUG_MOTOR_CCWR, SEQ_CTRL_START },
		{ 400,  SEQ_CTRL_SHD_MOTOR_OFF,  SEQ_CTRL_SHD_FLAP_OFF, SEQ_CTRL_FLUSH_OFF, SEQ_CTRL_SHDAUG_MOTOR_OFF, SEQ_CTRL_MID },
		{ 200,  SEQ_CTRL_SHD_MOTOR_CWR, SEQ_CTRL_SHD_FLAP_OFF, SEQ_CTRL_FLUSH_OFF, SEQ_CTRL_SHDAUG_MOTOR_OFF, SEQ_CTRL_MID },
		{ 400,  SEQ_CTRL_SHD_MOTOR_OFF,  SEQ_CTRL_SHD_FLAP_OFF, SEQ_CTRL_FLUSH_OFF, SEQ_CTRL_SHDAUG_MOTOR_OFF, SEQ_CTRL_MID },
		{ 200,  SEQ_CTRL_SHD_MOTOR_CWR, SEQ_CTRL_SHD_FLAP_OFF, SEQ_CTRL_FLUSH_ON,  SEQ_CTRL_SHDAUG_MOTOR_OFF, SEQ_CTRL_MID },
		{ 400,  SEQ_CTRL_SHD_MOTOR_OFF,  SEQ_CTRL_SHD_FLAP_OFF, SEQ_CTRL_FLUSH_OFF, SEQ_CTRL_SHDAUG_MOTOR_OFF, SEQ_CTRL_MID },
		{ 600,  SEQ_CTRL_SHD_MOTOR_CCWR,  SEQ_CTRL_SHD_FLAP_OFF, SEQ_CTRL_FLUSH_ON,  SEQ_CTRL_SHDAUG_MOTOR_OFF, SEQ_CTRL_MID },
		{ 400,  SEQ_CTRL_SHD_MOTOR_OFF,  SEQ_CTRL_SHD_FLAP_OFF, SEQ_CTRL_FLUSH_OFF, SEQ_CTRL_SHDAUG_MOTOR_OFF, SEQ_CTRL_MID },
		{ 1000, SEQ_CTRL_SHD_MOTOR_OFF,  SEQ_CTRL_SHD_FLAP_OFF, SEQ_CTRL_FLUSH_OFF, SEQ_CTRL_SHDAUG_MOTOR_OFF, SEQ_CTRL_MID },
		{ 1300, SEQ_CTRL_SHD_MOTOR_OFF,  SEQ_CTRL_SHD_FLAP_OPEN,  SEQ_CTRL_FLUSH_OFF, SEQ_CTRL_SHDAUG_MOTOR_OFF, SEQ_CTRL_MID },
		{ 100,  SEQ_CTRL_SHD_MOTOR_OFF,  SEQ_CTRL_SHD_FLAP_CLOSE, SEQ_CTRL_FLUSH_OFF, SEQ_CTRL_SHDAUG_MOTOR_OFF, SEQ_CTRL_END },
		};
